...
URL="https://informacioncorporativa.entel.cl/files.json?category=presentations&limit=40&tags=2021&callback=jQuery18308433009245375991_1625063460594"
...
for year in range(13,22):
    PAGE_URL_3=URL[:90]+str(year)+URL[92:]
    documents.extend(scrap.scrapping_3(PAGE_URL_3));
